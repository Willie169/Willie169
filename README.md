...
The languages I use most often are **Traditional Chinese (Taiwan)** (native, main), **English** (main), **C/C++** (main), **JavaScript/Node.js**, **Java**, **Python**, **Shell**, **LaTaX** (main), and **HTML**.
